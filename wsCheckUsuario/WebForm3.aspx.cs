    ...
    public partial class WebForm3 : System.Web.UI.Page
    {
        ...
        protected async void ImageButton1_Click1(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    string apiUrl = $"https://localhost:44394/check/usuario/spbuscarusuarioclave?clave={clave}";
        ...
        protected async void Button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    string apiUrl = "https://localhost:44394/check/usuario/spupdusuario";
        ...
        protected async void Button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    string apiUrl = $"https://localhost:44394/check/usuario/spdelusuario?clave={clave}";
